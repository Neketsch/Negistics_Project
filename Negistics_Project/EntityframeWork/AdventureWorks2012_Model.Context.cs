...
namespace Negistics_Project.EntityframeWork
{
    ...
    public partial class AdventureWorks2012_DataEntities : DbContext
    {
        ...
        public virtual DbSet<Product_Disconts> Product_Disconts { get; set; }
    
        [DbFunction("AdventureWorks2012_DataEntities", "ufnGetContactInformation")]
        public virtual IQueryable<ufnGetContactInformation_Result> ufnGetContactInformation(Nullable<int> personID)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<ufnGetContactInformation_Result>("[AdventureWorks2012_DataEntities].[ufnGetContactInformation](@PersonID)", personIDParameter);
        }
